...
# Check database
if (-Not (Test-Path ".\backend\foodscan.db")) {
    Write-Host "[WARNING] Database not found! Will be created on first run..." -ForegroundColor Yellow
}
...
Write-Host ""
Write-Host "Database: SQLite (14,945 recipes)" -ForegroundColor Cyan
